...
class AttentionConfig:
    ...
    """TurboQuant v56 GEMV-fused kernel context gate. 0 = no limit (always
    prefer v56 when B <= threshold). The in-kernel GEMV avoids a separate
    rocBLAS launch and is net-positive even at long context."""
