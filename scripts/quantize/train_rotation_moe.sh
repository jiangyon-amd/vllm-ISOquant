#!/bin/bash
# MoE 模型: 训练 rotation + 导出量化模型
# Usage: bash scripts/quantize/train_rotation_moe.sh <BF16_MODEL> <OUTPUT_DIR> [GPU]
#
# Example:
#   bash scripts/quantize/train_rotation_moe.sh \
#     /data/jiangyon/hf_cache/models--Qwen--Qwen3-30B-A3B/snapshots/ad44e777bcd18fa416d9da3bd8f70d33ebb85d39 \
#     qwen3-30b-mxfp4-trained-r128-vllm 0
