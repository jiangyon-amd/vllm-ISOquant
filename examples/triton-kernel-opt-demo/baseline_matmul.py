...
MAIN_CHANGE = "Round 1 baseline kernel with straightforward linear program ordering."
...
AUTOTUNE_CONFIGS = [
    ...
    triton.Config({"BLOCK_M": 256, "BLOCK_N": 64, "BLOCK_K": 32, "GROUP_M": 1},
                  num_stages=4, num_warps=8),
