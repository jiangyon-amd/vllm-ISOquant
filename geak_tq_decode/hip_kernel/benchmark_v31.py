...
def main():
    ...
    # v31
    mid_o_v31 = torch.zeros(B, Hq, NUM_KV_SPLITS, D + 1, dtype=torch.float32, device=DEVICE)
    run_v31 = run_hip_kernel(os.path.join(HIP_DIR, "tq_decode_stage1_v31.so"), q_rot, kv_cache, bt, sls, centroids_f32, mid_o_v31, B, Hq, NUM_KV_SPLITS, BLOCK_KV=8)
    run_v31(); torch.cuda.synchronize()
    v31_us = bench("HIP v31 (reg centroids)", run_v31)
    
    print(f"\n  Speedup v31 vs v12: {v12_us/v31_us:.2f}x")
