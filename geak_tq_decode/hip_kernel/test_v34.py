#!/usr/bin/env python3
"""Test correctness of v34 kernel."""
...
def main():
    ...
    if max_diff < 0.1:
        print("PASS: v34 output matches v12 reference")
    else:
        print("FAIL: v34 output differs from v12 reference")
        # Show where the differences are
        print(f"v12 sample: {mid_o_v12[0, 0, 0, :5]}")
        print(f"v34 sample: {mid_o_v34[0, 0, 0, :5]}")
