...
def main():
    ...
    # v30
    mid_o_v30 = torch.zeros(B, Hq, NUM_KV_SPLITS, D + 1, dtype=torch.float32, device=DEVICE)
    run_v30 = run_hip_kernel(os.path.join(HIP_DIR, "tq_decode_stage1_v30.so"), q_rot, kv_cache, bt, sls, centroids_f32, mid_o_v30, B, Hq, NUM_KV_SPLITS, BLOCK_KV=16)
    run_v30(); torch.cuda.synchronize()
    v30_us = bench("HIP v30 (BLOCK_KV=16)", run_v30)
    
    print(f"\n  Speedup v30 vs v12: {v12_us/v30_us:.2f}x")
