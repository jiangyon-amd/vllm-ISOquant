#!/usr/bin/env python3
"""Final benchmark for v12 kernel."""
...
def main():
    ...
    print(f"\n=== FINAL BENCHMARK: B={B}, seq_len={seq_len}, NUM_KV_SPLITS={NUM_KV_SPLITS} ===")
    ...
    v12_us = bench("HIP v12 (optimized)", run_v12)
    
    print(f"\n  Speedup vs Triton: {triton_us/v12_us:.2f}x")
    print(f"  Target: <150 us")
    print(f"  Status: {'PASS' if v12_us < 150 else 'FAIL'}")
