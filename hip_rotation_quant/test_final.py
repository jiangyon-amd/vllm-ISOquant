...
print("=" * 70)
print("Final Performance Test: Dense MFMA Rot+Quant HIP Kernel")
print("=" * 70)
...
print(f"  {'M':>4} {'v1 (baseline)':>14} {'v8 (optimized)':>16} {'Gluon v2':>10} {'speedup':>10}")
print(f"  {'-'*60}")

for M in [1, 4, 32]:
    t_v1 = benchmark("launch_dense_mfma_rot_quant_v1", M, 4096)
    t_v8 = benchmark("launch_dense_mfma_rot_quant_v8", M, 4096)
    t_gluon = 14.5  # Reference from problem statement
    speedup = t_v1 / t_v8
    print(f"  {M:4d} {t_v1:14.1f}µs {t_v8:16.1f}µs {t_gluon:10.1f}µs {speedup:10.2f}x")
