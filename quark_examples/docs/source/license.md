<head>
  <meta charset="UTF-8">
  <meta name="description" content="Quark licensing terms">
...
:::{note}
The preceding license applies to the [Quark repository](https://github.com/amd/quark-documentation), which
primarily contains documentation.
:::

```{note}
The following additional terms and conditions apply to your use of Quark technical documentation.
```
