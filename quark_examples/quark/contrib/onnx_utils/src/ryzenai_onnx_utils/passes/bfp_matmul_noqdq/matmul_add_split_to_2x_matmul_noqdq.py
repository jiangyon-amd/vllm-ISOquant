...
def replacement(
    ...
    matmul_output_2 = split.output[1] + f".out{pass_id}_path_2"
    ...
    post_cast_2, post_cast_tvi_2 = add_cast_to_float(matmul_output_2, split.output[1], [1, m, split_n], domain)
...
PATTERN = ["MatMul([?,?], a0)", "Add([?,a0], a1)", "Split(a1,[?,?])"]
