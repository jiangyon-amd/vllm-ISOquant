...
def replacement(
    ...
    if matmul.name != "/decoder/mid_block/attentions.0/to_v/MatMul":
    ...
    bfp_to_bf_output_tvi = onnx.helper.make_tensor_value_info(bfp_to_bf_output, onnx.TensorProto.BFLOAT16, [1, n, m])
    ...
    post_cast, post_cast_tvi = add_cast_to_float(bfp_to_bf_output, add.output[0], [1, n, m], domain)
