...
#
"""ONNX Quantizer Configurations in Quark 0.x"""
...
class QuantizationConfig:
    ...
    calibrate_method: CalibrationMethod | PowerOfTwoMethod = CalibrationMethod.MinMax
    quant_format: QuantFormat | ExtendedQuantFormat = QuantFormat.QDQ
    activation_type: QuantType | ExtendedQuantType = QuantType.QInt8
    weight_type: QuantType | ExtendedQuantType = QuantType.QInt8
