...
from quark.onnx.quantization.quantize import quantize_static
from quark.onnx.utils.model_utils import create_infer_session_for_onnx_model

from .torch_utils import convert_onnx_to_torch, parse_options_to_params, train_torch_module_api
...
def run_onnx_model(model_path: str) -> Any:
    ...
    sess = create_infer_session_for_onnx_model(model_path, so, providers=["CPUExecutionProvider"])
