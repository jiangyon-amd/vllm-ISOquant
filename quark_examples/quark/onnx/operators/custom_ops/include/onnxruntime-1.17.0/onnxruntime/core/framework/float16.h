...
struct MLFloat16 : onnxruntime_float16::Float16Impl<MLFloat16> {
 ...
 public:
  ...
  // Using inherited implementation instead of math floatToHalf allows us to use
  // this in other shared providers without having to implement the bridge
  ...
  // Using inherited implementation instead of math halfToFloat allows us to use
  // this in other shared providers without having to implement the bridge
