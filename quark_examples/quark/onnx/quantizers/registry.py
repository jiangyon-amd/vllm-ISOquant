...
from quark.onnx.operators.quant_ops.hardsigmoid import QDQHardSigmoid
from quark.onnx.operators.quant_ops.layernorm import QDQLayerNorm
from quark.onnx.operators.quant_ops.prelu import QDQPRelu
...
def CreateOpQuantizer(onnx_quantizer: Any, node: NodeProto) -> QuantOperatorBase | Any:
...
def CreateNPUTransformerQDQQuantizer(onnx_quantizer: Any, node: NodeProto) -> QDQOperatorBase | Any:
...
def CreateNPUCnnQDQQuantizer(onnx_quantizer: Any, node: NodeProto) -> QDQOperatorBase | Any:
...
def CreateQDQQuantizer(onnx_quantizer: Any, node: NodeProto) -> QDQOperatorBase | Any:
